    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#1A1A1A">
          <div style="background:#E8927C;padding:24px 28px;border-radius:12px 12px 0 0">
          ...
          <div style="background:#FAF5EE;padding:28px;border-radius:0 0 12px 12px;border:1px solid #E5DFD6;border-top:none">
            <table style="width:100%;border-collapse:collapse">
              ...
              <tr><td style="padding:8px 0;font-size:12px;color:#6B6B6E;text-transform:uppercase;letter-spacing:0.1em">E-mail</td><td style="padding:8px 0"><a href="mailto:${email}" style="color:#C96E55">${email}</a></td></tr>
        ...
        <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#1A1A1A">
          ...
          <div style="background:#FAF5EE;padding:32px;border-radius:0 0 12px 12px;border:1px solid #E5DFD6;border-top:none">
            ...
            <p style="margin:0 0 24px;line-height:1.65;color:#2D2D2D">
              Wil je eerder contact? Stuur me een WhatsApp-bericht op <a href="https://wa.me/31629242833" style="color:#C96E55">+31 6 29 24 28 33</a>.
            </p>
